...
topo readlammpsdata before_cross_linking_NC_fixed_final.data  
...
if {$i<=9} {
$sel set type "A1$i" 
set newtypename "A1$i"  
} elseif { $i<=19 } {
set newtype [expr $i%10]
$sel set type "A2$newtype"  
set newtypename "A2$newtype"
} else {
set newtype [expr $i%10]
$sel set type "A3$newtype"  
set newtypename "A3$newtype"
}
...
topo retypebonds
topo retypeangles
topo writelammpsdata topo_linking.data
set sel [atomselect top "type A29"]
set type19 [$sel num]
set sel [atomselect top "type A30"]
set type20 [$sel num]
