...
read_data		PVA_NP_OXY_LARGE_EQUILIBRATED_WITH_CHARGE.data
...
dump			1 O2 custom 100 MSD_unlink_win.lammpstrj type id xu yu zu # unwrapped coordinates
...
unfix			1
#final 
write_data		PVA_NP_OXY_LARGE_EQUILIBRATED_WITH_CHARGE_MSD.data
