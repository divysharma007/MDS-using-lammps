...
float dist(struct atom a1, struct atom a2){
    ...
    yd = a1.y - a2.y;
    zd = a1.z - a2.z;
    float d = 0,h=-29.68514112033091+60.2708568796706;
    if(2*abs(xd) > h){
        xd = xd - (sgn(xd)*h);
    }
...
// Storing Input Equillibrated Packed Mixture Data
    ...
    vector<atom> atoms, atom7, atom10, atom11;
    string line;
    ...
    vector<bond> bonds,bond7,bond8,bond10,bond11,bond12;
    while (getline(bondsFile, line))
    {
        ...
        if(v[1]=="12")bond12.push_back(temp);
    }
    int l=bonds.size();
    bondsFile.close();
    ...
    for(int i=0;i<atom11.size();i++){
        // Searching for O1 Atoms
        for(int j=0;j<atom10.size();j++){

                //Single Crosslinking of c1-O1
                if(((atom11[i].type==11) && (atom10[j].type==10) && dist(atom11[i],atom10[j])<=cutoff*cutoff)){

                        //Forming c1-O1 Bond
                        struct bond nb;
                        nb.bondNo = l+1;
                        nb.type = 15;
                        nb.a1=atom11[i].atomNo;
                        nb.a2=atom10[j].atomNo;
                        bonds.push_back(nb);
                        l++;
                        ...
                        for(auto ac = atoms.begin();ac!=atoms.end();ac++){
                                if((*ac).atomNo == atom10[j].atomNo){
                                        (*ac).type = 15;
                                }
                        }
                        atom11[i].type = 16;
                        for(auto ac = atoms.begin();ac!=atoms.end();ac++){
                                if((*ac).atomNo == atom11[i].atomNo){
                                        (*ac).type = 16;
                                }
                        }
                        ...
                        for (int b=0;b<bond10.size();b++){
                                if(atom11[i].atomNo==bond10[b].a1){
                                    c2c1 = bond10[b].a2;
                                }
                                else if(atom11[i].atomNo==bond10[b].a2){
                                    c2c1 = bond10[b].a1;
                                }
                        }
                        struct angle na;
                        na.angleNo = al+1;
                        na.type = 26;
                        na.a1=atom10[j].atomNo;
                        na.a2=atom11[i].atomNo;
                        na.a3=c2c1;
                        angles.push_back(na);
                        al++;
                        ...
                        for (int b=0;b<bond7.size();b++){
                                if(atom10[j].atomNo==bond7[b].a1){
                                    C2O = bond7[b].a2;
                                }
                                else if(atom10[j].atomNo==bond7[b].a2){
                                    C2O = bond7[b].a1;
                                }
                        }
                        struct angle na1;
                        na1.angleNo = al+1;
                        na1.type = 29;
                        na1.a1=atom11[i].atomNo;
                        na1.a2=atom10[j].atomNo;
                        na1.a3=C2O;
                        ...
                        //h-c1-O1 Angle
                        int h1=-1;
                        for (int b=0;b<bond11.size();b++){
                                if(atom11[i].atomNo==bond11[b].a1){
                                    h1 = bond11[b].a2;
                                }
                                else if(atom11[i].atomNo==bond11[b].a2){
                                    h1 = bond11[b].a1;
                                }
                        }
                        struct angle na2;
                        na2.angleNo = al+1;
                        na2.type = 27;
                        na2.a1=atom10[j].atomNo;
                        na2.a2=atom11[i].atomNo;
                        na2.a3=h1;
                        ...
                        for (int b=0;b<bond8.size();b++){
                            if(bond8[b].type == 8){
                                ...
                                else if(atom10[j].atomNo==bond8[b].a2){
                                    H=bond8[b].a1;
                        ...
                        for(int p=0;p<bond12.size();p++){
                                if(bond12[p].type == 12){
                                    if(atom11[i].atomNo==bond12[p].a1){
                                        O = bond12[p].a2;
                                        ...
                                        for(auto bc = bonds.begin();bc!=bonds.end();bc++){
                                            if(bond12[p].a1==(*bc).a1 && bond12[p].a2==(*bc).a2){
                                                (*bc).type = 17;
                                            }
                                        }
                                    }
                                    else if(atom11[i].atomNo==bond12[p].a2){
                                        O = bond12[p].a1;
                            ...
                            na5.angleNo = al+1;
                            na5.type = 28;
                            na5.a1=atom10[j].atomNo;
                            na5.a2=atom11[i].atomNo;
                            na5.a3=O;
                    ...
                    //Double Crosslinking of c1-O1
                    else if((atom11[i].type==16) && (atom10[j].type==10) && dist(atom11[i],atom10[j])<=cutoff*cutoff){
                        //Forming c1-O1 Bond
                        struct bond nb;
                        nb.bondNo = l+1;
                        nb.type = 15;
                        ...
                        for(auto ac = bonds.begin();ac!=bonds.end();ac++){
                                if((*ac).type == 15 && (*ac).a2 == atom11[i].atomNo && atom10[j].atomNo != (*ac).a1){
                                        O1c1 = (*ac).a1;
                                }
                                else if((*ac).type == 15 && (*ac).a1 == atom11[i].atomNo && atom10[j].atomNo != (*ac).a2){
                                        O1c1 = (*ac).a2;
                                }
                        }
                        struct angle na6;
                        na6.angleNo = al+1;
                        na6.type = 30;
                        na6.a1=atom10[j].atomNo;
                        na6.a2=atom11[i].atomNo;
                        na6.a3=O1c1;
                        ...
                        //Finding Neighbouring o Atom
                        for(int p=0;p<bond12.size();p++){
                            if(bond12[p].type == 17 && atom11[i].atomNo==bond12[p].a1){
                                O = bond12[p].a2;
                                ...
                                bond12[p].type = 50;
                                for(auto bb = bonds.begin();bb!=bonds.end();bb++){
                                    if(bond12[p].a1==(*bb).a1 && bond12[p].a2==(*bb).a2){
                                        (*bb).type = 50;
                                    }
                                }
                            }
                            else if(bond12[p].type == 17 && atom11[i].atomNo==bond12[p].a2){
                                O = bond12[p].a1;
                        ...
                        int HO1 = -1;
                        for(auto ac = bonds.begin();ac!=bonds.end();ac++){
                                if((*ac).type == 16 && (*ac).a2 == O){
                                    HO1 = (*ac).a1;
                                    (*ac).type = 50;
                                }
                                else if((*ac).type == 16 && (*ac).a1 == O){
                                    HO1 = (*ac).a2;
                                    (*ac).type = 50;
                                }
                        }
                        ...
                        for(auto bb = angles.begin();bb!=angles.end();bb++){
                                if(O==(*bb).a2){
                                    if((HO1==(*bb).a1 && atom11[i].atomNo==(*bb).a3)||(HO1==(*bb).a3 && atom11[i].atomNo==(*bb).a1)){
                                        (*bb).type = 50;
                                    }
                                }
                        }
    ...
    bout.open("PVA4_GA20_OXY10_CROSSLINKED.data");
    bout<<"Atoms"<<endl;
    bout<<""<<endl;
    for(int i=0;i<atoms.size();i++){
        bout<<atoms[i].atomNo<<" "<<atoms[i].sec<<" "<<atoms[i].type<<" "<<atoms[i].charge<<" "<<atoms[i].x<<" "<<atoms[i].y<<" "<<atoms[i].z<<" "<<atoms[i].hash<<" "<<atoms[i].s1<<" "<<atoms[i].s2<<endl;
